...
mods.thaumcraft.Aspects.set(<TConstruct:materials:4>, "metallum 3, terra 2, ignis 2"); //Ardite
mods.thaumcraft.Aspects.set(<TConstruct:materials:5>, "metallum 3, motus 1, terra 1, ignis 1, tutamen 1"); //Manyulyn
mods.thaumcraft.Aspects.set(<TConstruct:materials:11>, "metallum 3, machina 1"); //Aluminum
mods.thaumcraft.Aspects.set(<TConstruct:materials:14>, "metallum 3, machina 2"); //Aluminum Brass
mods.thaumcraft.Aspects.set(<TConstruct:materials:15>, "metallum 3, instrumentum 2"); //Alumite
mods.thaumcraft.Aspects.set(<TConstruct:materials:18>, "metallum 3, tenebrae 1"); //Obsidian
mods.thaumcraft.Aspects.set(<TConstruct:materials:34>, "metallum 3, corpus 2"); //Pig Iron

mods.thaumcraft.Aspects.set(<ThermalFoundation:material:74>, "metallum 3, motus 1, tutamen 1, machina 1"); //Signalum
mods.thaumcraft.Aspects.set(<ThermalFoundation:material:71>, "metallum 3, lucrum 1"); //Electrum
mods.thaumcraft.Aspects.set(<ThermalFoundation:material:75>, "metallum 3, machina 1, lux 2"); //Lumium
...
mods.thaumcraft.Aspects.set(<TConstruct:Smeltery:4>, "terra 3, ignis 2"); //Seared Nether brick
mods.thaumcraft.Aspects.set(<TConstruct:Smeltery:5>, "terra 2, ignis 1, perdito 2"); //Seared Nether brick
mods.thaumcraft.Aspects.set(<TConstruct:Smeltery:6>, "terra 3, ignis 2"); //Seared Nether brick
...
mods.thaumcraft.Aspects.set(<ThermalFoundation:Storage:10>, "metallum 20, motus 7, tutamen 7, machina 7"); //Signalum
mods.thaumcraft.Aspects.set(<ThermalFoundation:Storage:11>, "metallum 20, machina 7, lux 13"); //Lumium
